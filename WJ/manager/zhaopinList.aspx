<%@ Page Title="" Language="C#" MasterPageFile="~/manager/ljxMaster.master" AutoEventWireup="true" CodeFile="zhaopinList.aspx.cs" Inherits="manager_zhaopinList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="RightURL" Runat="Server">
     <p>
        你当前位置：招聘管理 -&gt; 招聘信息编辑列表</p>
</asp:Content>
