<%@ Page Title="" Language="C#" MasterPageFile="~/ljxPageMaster.master" AutoEventWireup="true" CodeFile="zhaopin.aspx.cs" Inherits="zhaopin" %>
                                            ...
                                            <ItemTemplate>
                                                <table style="width: 100%;" border="0" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        ...
                                                        <%# CutStr(DataBinder.Eval(Container.DataItem, "招聘内容 "))%></a>
                                                        </td>
                                                        <td align="right">
